...
draft: false
description: "從二月備考到考出數甲 59、物理 60、化學 60 的心得整理，包含時間規劃、資源選擇、心態調整，以及大學後對升學制度的反思"
...
這是我第一次模考的分數：
![第一次模考分數](/images/mock-test-score.png)
...
1. 重讀了分科範圍
2. 對整個分科範圍做了一套筆記
3. 刷了大約 50 ~ 70 份歷屆模考，以及 103 到 112 年的分科歷屆試題
4. 做錯題本
...
- **二月中到五月中**：重讀分科範圍並且做筆記
- **五月中到考試前**：每天刷模考、檢討並且做錯題本

> 在二月中到五月中，我的重心完全放在理解概念以及做筆記上，沒有寫任何一份考古。只專心在一件事：把我所有的疑惑都解開。
...
1. 可以最大化利用考題資源
2. 知識是連貫的，而非透過考卷碎片化地進來
3. 全部讀完後開始寫考卷，進步速度會很快

> 大概開始刷了十份模考後，就可以穩定在 50 級分以上。

但壞處是：

1. 沒辦法充分利用模考（因為還沒讀完考試範圍）
2. 需要嚴謹的時間規劃（不然可能考卷沒刷完正式考試就到了）

> 所以週末很大的作用，就是將平日欠下沒讀完的進度補完。
...
| 九陰真經 | 跟時代脫節，其中許多知識在分科都不會遇到；內容公式有許多錯誤，不知道是不是故意不修。我分科期間僅讀了有機和無機章節，這兩章需要大量背誦，九陰真經這種完整型講義剛好適合（但我在高一二曾讀過它的其他章節） |
| 周衝刺 | 同物理 |

> 之後或許會有比較詳細的評價，但或許我會懶得寫，而且也忘得有點多了。
...
北模、中模各種模每年都會產生好幾套試卷，這些題目的目的就是模擬正式考試，並且要供給數萬考生使用，題目品質還算有保障。
...
所以當我到正式考場時，我居然沒有緊張！到現在我還是覺得很神奇。考試當下的心態就跟刷模考一樣，用一樣的策略、一樣的思維、一樣的檢查方式，按部就班地將考卷寫完。

> 但這不是說我正式考試不會緊張——考學測的時候數 A 緊張到一直冒手汗，最後直接把自己送到分科。

### 我怎麼做到的

#### 規律的生活

從五月開始我每天的行程都非常固定：早起刷模考、午覺睡完刷模考、吃完晚餐刷模考。模考的形式和正式考試一模一樣，所以某種程度上我在正式考試前已經模擬了數十次考試流程。

#### 吃巧克力

在備考期間我看到了一篇文章說：「運動員在比賽前都會有一個自己習慣的動作幫助自己緩解緊張。」所以我就嘗試在每次寫模考前都吃一塊巧克力，讓甜蜜的滋味充滿我的味蕾。

或許這個方法有幫助？又或者沒有？其實我也不知道。

#### 信心

我將所有的歷屆試題留到考前兩週才寫，因為我認為這些歷屆試題是最寶貴的資源。為了讓我有最真實的正式考試模擬，之前寫講義時對於所有歷屆試題我都直接跳過不做，並且在那兩週嚴格按照正式考試時程走。

在這兩週中，我寫的所有歷屆除了 111 年和 112 年的數甲壓在 60 級分線上外，其他考卷都遠高於 60 級分線，這或許給了我很大的信心。
...
例如：看到空間中的兩條線，要先確定是重合、平行、相交還是歪斜。如果是歪斜又有哪幾種題目？要怎麼最快速求出兩歪斜線的最短距離？要怎麼求出最短距離那條線的方程式？這條線和原本歪斜的兩條線交點要怎麼求出？

> **Overfitting** 指的是機器學習模型在訓練集上表現得很好，但在實際使用時表現不佳的情況。對應到這裡的場景就是：我們不用去想以後要怎麼運用這些分科知識，只需要想辦法去 Overfit 分科測驗這個訓練集就好了。
...
2. 雖然有將近半年可以準備，但對於完全重讀的我來說還是很緊湊。因此我那段期間的備考哲學就是：看過、寫過筆記的講義可以丟掉，寫完、檢討過的考卷可以進回收桶。我絕不把時間浪費在同樣一份文件上兩次。
...
我在大學對此感受更深——每天睡足七八小時，真的可以讓思考的速度以及準確度提升好幾個檔次。熬夜讀書，不是時間分配不合理，就是用這個來催眠自己已經很認真了，就算最後失敗也盡力了。但你只是盡力讀書，沒有去想怎麼讀的更有效率、讀的更深、記得更牢。

#### 找一些不太耗時間的小興趣

壓力也會讓人崩潰，也會嚴重影響身心狀況。尋找一些不太消耗時間的小興趣，從中找到快樂，可以支持你度過這數個月的高壓。

像是聽音樂、魔術方塊、運動、曬太陽……

> 不要看小說，我用自身經驗告訴你你會不小心沉迷進去。

#### 和同學討論

遇到難題或解得很慢的題目時，去找程度相當的同學討論。每個人不斷提出新的想法、抓出他人想法的漏洞，可以很快地幫助你們進步——因為這個過程你在將原本只會用來解題的知識，用來反駁他人提出的解法，這需要對那些知識概念有更深的理解。
...
| 工具 | 評價 |
| :--- | :--- |
| Claude Sonnet 4.6 | 解釋概念的能力明顯優於 Gemini、ChatGPT、Deepseek 等，現在也能快速生成 Flowchart 和 Diagram 來視覺化概念 |
| Gemini 3 Thinking/Pro | 數學物理解題非常強 |
| NotebookLM | 有數十到數百頁講義時請用 NotebookLM，一般模型容易因 RAG 技術產生幻覺 |

> 雖然市面上也有不少專為學習設計的產品，但我目前覺得這三個就夠用了，而且 Gemini 之前有送一年訂閱實在太香了（Ｘ
...
備考會有很重的壓力，特別是對於那些自我期許很高的人。有些考生可能給自己太大的壓力，因而完全放棄所有娛樂，但這是不健康的。壓力持續累積會讓人腦袋遲鈍、睡眠變差，反而越讀越沒效率。

如果考生打了一下遊戲、聽了點音樂、滑了一下社群媒體，他或許正在釋放壓力。請不要打擾他，讓他好好休息。

### 不要質疑他做的努力與選擇

合格的考生會自己去理解考試制度、理解怎麼準備考試。家長與考生的年代已經相去久遠，如果你不能保證你對他做法的質疑，以及你認為他應該做的事，是符合這個時代的，那就請不要提出意見，讓他按著自己的步調前進。

> 當然，如果他自己表現出需要幫助，不管是什麼方面的，問問他吧。
...
但它沒有篩選的東西更多——領導能力、研究能力、規劃活動的能力、協調事務的能力、與人互動的能力。這些能力在現實世界裡一點都不亞於學科能力，只是它們沒辦法被客觀量化，所以大考中心就乾脆不管了。
